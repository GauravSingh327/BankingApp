...
class AllUsersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(check.equals("Insert"))
        {
            ...
            db.insertUsers("Gaurav","Kholiyagaurav@gmail.com",5000)
            db.insertUsers("Ankit","ankit@gmail.com",500)
            db.insertUsers("Rohit","rohit@gmail.com",1000)
            db.insertUsers("Anuk","Anuk@gmail.com",1500)
            db.insertUsers("Binay","binay@gmail.com",2500)
            db.insertUsers("Samay","samay@gmail.com",1700)
            db.insertUsers("Hritick","Hritick@gmail.com",1800)
            db.insertUsers("Bhanu","Bpc@gmail.com",5000)
            db.insertUsers("chessindia","chessindia121@gmail.com",1900)
            db.insertUsers("Raju","rajendra@gmail.com",3000)
